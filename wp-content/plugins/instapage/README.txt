...
In version 2.30 we added a plugin diagnostic tool. It's disabled by default 
and it can be turned on only by user's request. It's used to log events in 
the plugin, which help us detect and fix all the problems. Logs are 
protected and they don't contain personal information.
...
= 2.33 =
- Fixed: invalid 500 response from application
- Fixed: non-www, www issue
- Fixed: links on 500 page 

= 2.32 =
- Fixed: page status doesn't change after unpublish via plugin
- Fixed: search doesn't work
- Fixed: landing page doesn't work if it has additional parameters in URL
- Fixed: move to trash should be deleted
- Added: ability to add custom parameters which should be ignored by plugin

= 2.31 =
- Fixed: Make diagnostic accessible without logging in
- Changed: API endpoint address

= 2.30 =
- Fixed: performance issues
- Fixed: server log errors
- Added: dignostic tool
