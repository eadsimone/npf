...
<!--					<div class="readmore-post"><a class="" href="--><?php //the_permalink(); ?><!--">Read More<span class="glyphicon glyphicon-menu-right"></span></a></div>-->
				<div id="readmore-post" class="readmore-post"><a id="blog-readmore" class="btn btn-default read-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php esc_html_e( 'Read More', 'sparkling' ); ?><span class="glyphicon glyphicon-menu-right"></span></a></div>
